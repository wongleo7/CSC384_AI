...
def alphabeta_search(state):
    ...
    '''
    d = 15 #this is the cutoff test depth value. if we exceed this value, stop
    cutoff_test=None
    eval_fn = None 
    ...
    def max_value(state, alpha, beta, depth):
        ...
        for a in state.actions():
            #print "max call:"
            #print state.board['Avail']
            #print state.moves
            #print a
            #print "--"
            #print state.board
            #print "--"
            #print state.connectedPieces
            #print "--"
            #print state.player
...
def query_player(state):
    ...
    x = num_or_str(raw_input('Your x move? '))
    y = num_or_str(raw_input('Your y move? '))
    return (x,y)
